...
class DemoCmsTwigService extends MelisCoreGeneralService
{
     ...
     * @param int $limit , to limit the subpage, set on config.MelisDemoCmsTwig.php
     * @param int $newsMenuPageId , custom data to be modified, set on config.MelisDemoCmsTwig.php
     *
     * @return Array
     */
